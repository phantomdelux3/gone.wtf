...
export const EvervaultCard = ({
  ...
  useEffect(() => {
    const next = generateRandomString(1500);
    setRandomString(next);
  }, []);
  ...
  return (
    <div
      className={cn(
        "p-0.5  bg-transparent aspect-square flex items-center justify-center w-full min-h-[6rem] max-h-[12.37rem] relative",
        className
      )}
    >
      <div
